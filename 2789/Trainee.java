...
/**
 * Entity class to hold trainee personal information.
 */
public class Trainee implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (traineeId != trainee.traineeId) return false;
        if (age != trainee.age) return false;
        if (!traineeName.equals(trainee.traineeName)) return false;
        if (!contactNo.equals(trainee.contactNo)) return false;
